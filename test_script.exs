...
IEx.Helpers.c("paxos_test_additional.ex", ".")
...
test_suite = [
  ...
  #     {&PaxosTest.run_simple_3/3, TestUtil.get_local_config(3), 10, "No failures, 2 concurrent instances, 3 local procs"}, # this doesn't work
  ...
  #   {&PaxosTestAditional.run_leader_crash_simple_before_decision/3,
  #    TestUtil.get_dist_config(host, 5), 10,
  #    "Leader crashes right before decision, no concurrent ballots, 5 nodes"},
  #   {&PaxosTestAditional.run_leader_crash_simple_before_decision/3, TestUtil.get_local_config(5),
  #    10, "Leader crashes right before decision, no concurrent ballots, 5 local procs"},
  #   {&PaxosTestAditional.run_non_leader_send_propose_after_leader_elected/3,
  #    TestUtil.get_dist_config(host, 5), 10, "Non-Leader proposes after leader is elected, 5 nodes"},
  #   {&PaxosTestAditional.run_non_leader_send_propose_after_leader_elected/3,
  #    TestUtil.get_local_config(5), 10,
